...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    self.detailViewController.contact = contact;
    self.detailViewController.context = self.fetchedResultsController.managedObjectContext;
    [self.navigationController pushViewController:self.detailViewController animated:YES];
}
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    Contact *relevantContact = [self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = relevantContact.name;
}
